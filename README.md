...
[![arduino-library-badge](https://www.ardu-badge.com/badge/AsyncESP8266_W5100_Manager.svg?)](https://www.ardu-badge.com/AsyncESP8266_W5100_Manager)
[![GitHub release](https://img.shields.io/github/release/khoih-prog/AsyncESP8266_W5100_Manager.svg)](https://github.com/khoih-prog/AsyncESP8266_W5100_Manager/releases)
[![GitHub](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/khoih-prog/AsyncESP8266_W5100_Manager/blob/main/LICENSE)
[![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](#Contributing)
[![GitHub issues](https://img.shields.io/github/issues/khoih-prog/AsyncESP8266_W5100_Manager.svg)](http://github.com/khoih-prog/AsyncESP8266_W5100_Manager/issues)
...
* [Why do we need this AsyncESP8266_W5100_Manager library](#why-do-we-need-this-async-AsyncESP8266_W5100_Manager-library)
  * [Features](#features)
...
* [Debug Terminal Output Samples](#debug-terminal-output-samples)
  * [1. Async_ConfigOnDoubleReset_TZ using LittleFS on ESP8266_NODEMCU_ESP12E with ESP8266_W5100](#1-Async_ConfigOnDoubleReset_TZ-using-LittleFS-on-ESP8266_NODEMCU_ESP12E-with-ESP8266_W5100)
  * [2. Async_ConfigOnSwichFS using LittleFS on ESP8266_NODEMCU_ESP12E with ESP8266_W5100](#2-Async_ConfigOnSwichFS-using-LittleFS-on-ESP8266_NODEMCU_ESP12E-with-ESP8266_W5100)
  * [3. Async_ESP_FSWebServer_DRD using LittleFS on ESP8266_NODEMCU_ESP12E with ESP8266_W5100](#3-Async_ESP_FSWebServer_DRD-using-LittleFS-on-ESP8266_NODEMCU_ESP12E-with-ESP8266_W5100)
* [Debug](#debug)
...
### Why do we need this Async [AsyncESP8266_W5100_Manager library](https://github.com/khoih-prog/AsyncESP8266_W5100_Manager)
...
To appreciate the power of the [ESPAsyncWebServer](https://github.com/me-no-dev/ESPAsyncWebServer) and underlying Async libraries, please compare the more efficient [Async_ESP_FSWebServer example](examples/Async_ESP_FSWebServer) example with the complicated twin [ESP32_FSWebServer](https://github.com/khoih-prog/ESP_WiFiManager/tree/master/examples/ESP32_FSWebServer).


#### Currently supported Boards

This [**AsyncESP8266_W5100_Manager** library](https://github.com/khoih-prog/AsyncESP8266_W5100_Manager) currently supports these following boards:
 ...
 <p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP8266_W5100_Manager/raw/main/Images/Wiznet-Ethernet-Hat_RP2040.png">
</p>
...
## Prerequisites
 ...
 4. [`ESPAsyncTCP v1.2.2+`](https://github.com/me-no-dev/ESPAsyncTCP) for ESP8266-based boards. **To install manually for Arduino IDE**
 5. [`ESP_DoubleResetDetector v1.3.2+`](https://github.com/khoih-prog/ESP_DoubleResetDetector) if using DRD feature. To install, check [![arduino-library-badge](https://www.ardu-badge.com/badge/ESP_DoubleResetDetector.svg?)](https://www.ardu-badge.com/ESP_DoubleResetDetector)
...
The best and easiest way is to use `Arduino Library Manager`. Search for `AsyncESP8266_W5100_Manager`, then select / install the latest version. You can also use this link [![arduino-library-badge](https://www.ardu-badge.com/badge/AsyncESP8266_W5100_Manager.svg?)](https://www.ardu-badge.com/AsyncESP8266_W5100_Manager) for more detailed instructions.

### Manual Install

1. Navigate to [AsyncESP8266_W5100_Manager](https://github.com/khoih-prog/AsyncESP8266_W5100_Manager) page.
2. Download the latest release `AsyncESP8266_W5100_Manager-main.zip`.
3. Extract the zip file to `AsyncESP8266_W5100_Manager-main` directory 
4. Copy the whole `AsyncESP8266_W5100_Manager-main` folder to Arduino libraries' directory such as `~/Arduino/libraries/`.

### VS Code & PlatformIO:

1. Install [VS Code](https://code.visualstudio.com/)
2. Install [PlatformIO](https://platformio.org/platformio-ide)
3. Install [**AsyncESP8266_W5100_Manager** library](https://registry.platformio.org/libraries/khoih-prog/AsyncESP8266_W5100_Manager) by using [Library Manager](https://registry.platformio.org/libraries/khoih-prog/AsyncESP8266_W5100_Manager/installation). Search for **AsyncESP8266_W5100_Manager** in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
...
```cpp
#include <AsyncESP8266_W5100_Manager.hpp>        //https://github.com/khoih-prog/AsyncESP8266_W5100_Manager
```

in many files. But be sure to use the following `#include <AsyncESP8266_W5100_Manager.h>` **in just 1 `.h`, `.cpp` or `.ino` file**, which must **not be included in any other file**, to avoid `Multiple Definitions` Linker Error
...
Have a look at the discussion in [Different behaviour using the src_cpp or src_h lib #80](https://github.com/khoih-prog/AsyncESP8266_W5100_Manager/discussions/80)
...
- The concept of [Async_ConfigOnSwitch](examples/Async_ConfigOnSwitch) is that a new `ESP8266` will start a ConfigPortal when powered up and save the configuration data in non volatile memory. Thereafter, the ConfigPortal will only be started again if a button is pushed on the `ESP8266` module.
...
These illustrating steps is based on the example [Async_ConfigOnSwitchFS](https://github.com/khoih-prog/AsyncESP8266_W5100_Manager/tree/main/examples/Async_ConfigOnSwitchFS)
...
The example [Async_ConfigOnSwitchFS](https://github.com/khoih-prog/AsyncESP8266_W5100_Manager/tree/main/examples/Async_ConfigOnSwitchFS) will open the CP whenever a SW press is detected in `loop()`. So the code to add `dynamic variables` will be there, just after the CP `AsyncESP8266_W5100_Manager` class initialization to create `AsyncESP8266_W5100_Manager` object.
...
Adding those `ESPAsync_EMParameter` objects created in Step 2 using the function `addParameter()` of object `AsyncESP8266_W5100_Manager`
...
After users select `Save`, the CP `AsyncESP8266_W5100_Manager` object will save the user input data into related `ESPAsync_EMParameter` objects.
...
<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP8266_W5100_Manager/raw/main/Images/Saved.png">
</p>
...
You can password protect the ConfigPortal AP. Check [Async_ESP_FSWebServer](examples/Async_ESP_FSWebServer) example
...
Many applications need configuration parameters like `MQTT host and port`, [Blynk](http://www.blynk.cc) or [emoncms](http://emoncms.org) tokens, etc. While it is possible to use [`AsyncESP8266_W5100_Manager`](https://github.com/khoih-prog/AsyncESP8266_W5100_Manager) to collect additional parameters, it is better to read these parameters from a web service once [`AsyncESP8266_W5100_Manager`](https://github.com/khoih-prog/AsyncESP8266_W5100_Manager) has been used to connect to the Internet.

To capture other parameters with [`AsyncESP8266_W5100_Manager`](https://github.com/khoih-prog/AsyncESP8266_W5100_Manager) is a little bit more complicated than all the other features. This requires adding custom HTML to your form. 

If you want to do it with [`AsyncESP8266_W5100_Manager`](https://github.com/khoih-prog/AsyncESP8266_W5100_Manager) see the example [Async_ConfigOnSwitchFS](examples/Async_ConfigOnSwitchFS)
...
### Examples
 ...
 6. [Async_ESP_FSWebServer](examples/Async_ESP_FSWebServer)
 7. [Async_ESP_FSWebServer_DRD](examples/Async_ESP_FSWebServer_DRD)
...
https://github.com/khoih-prog/AsyncESP8266_W5100_Manager/blob/b457174c77b574a2ff0bbf0602f9c940d8e030a7/examples/Async_ConfigOnSwitch/Async_ConfigOnSwitch.ino#L28-L797
...
This is terminal debug output when running [Async_ConfigOnDoubleReset](examples/Async_ConfigOnDoubleReset) on  **ESP8266_W5100**. `Config Portal` was requested by DRD to input and save Credentials, such as Static IP address.
...
This is terminal debug output when running [Async_ConfigOnSwichFS](examples/Async_ConfigOnSwichFS) on  **ESP8266_W5100**. `Config Portal` was requested to input and save Credentials.
...
This is terminal debug output when running [Async_ESP_FSWebServer_DRD](examples/Async_ESP_FSWebServer_DRD)  on  **ESP8266_W5100**. `Config Portal` was requested by DRD (also using **LittleFS**) to input and save Credentials.
...
Submit issues to: [AsyncESP8266_W5100_Manager issues](https://github.com/khoih-prog/AsyncESP8266_W5100_Manager/issues)
...
### Contributions and Thanks
 ...
 1. Thanks to [Hristo Gochkov](https://github.com/me-no-dev) for great [ESPAsyncWebServer Library](https://github.com/me-no-dev/ESPAsyncWebServer)
...
- The library is licensed under [MIT](https://github.com/khoih-prog/AsyncESP8266_W5100_Manager/blob/main/LICENSE)
